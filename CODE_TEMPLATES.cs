...
//Get Class
http://msk1-vm-ovisp02:2480/class/news_test2/Authorship
...
ALTER PROPERTY Object_SC.Id DEFAULT 'sequence("idseq").next()';
...
value "  \" ' ' \' \' \ 
		...
		*/
		/*GetUnitByAccount*/
		delete from Ofunction  where name in ["SearchByFNameLName","GetGUID","GetCollegesLowerByAccount","GetLowerCase","GetUnitByAccount","GetDepartmentByAccount","GetManagerByAccount","GetManagerHierarhyByAccount","GetCollegesByAccount"]
...
*/
	...
	public void TackBirthdays()
	{

create edge TrackBirthdays from 21:0 to 21:1
create edge TrackBirthdays from 21:0 to 21:2
create edge TrackBirthdays from 21:2 to 21:3
create edge TrackBirthdays from 21:4 to 21:2
select from TrackBirthdays
select from 21:2

select outE('TrackBirthdays').@rid from Person
where outE('TrackBirthdays').size() != 0
and outE('TrackBirthdays').inV('Person').GUID = '0963f5fe-cbae-11e4-b849-f80f41d3dd35'

delete edge TrackBirthdays where 1=1 and
outV('Person').GUID = '4e28f31a-89b8-11e4-bab2-00c2c66d13b0'
and inV('Person').GUID = '18a1450e-cbb4-11e4-b849-f80f41d3dd35'
