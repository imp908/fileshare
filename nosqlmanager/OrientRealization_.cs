...
namespace OrientRealization
{
  ...
  public class CommandShemasExplicit : Shemas
  {
      ...
      public ICommandBuilder In(List<ITypeToken> param_=null)
      {
  ...
  public class CommandsChain
  {
      ...
      public CommandsChain In(List<ITypeToken> param_)
      {
        this._commands = new List<ICommandBuilder>();
  ...
  public class OrientRepo : IOrientRepo
  {
    ...
    public T CreateEdge<T>(IorientDefaultObject edge_,IOrientVertex vFrom,IOrientVertex vTo,string dbName_=null) 
        where T:class,IorientDefaultObject            
    {
      CheckDbName(dbName_);
      ...
      //edge count
      ITypeToken edgCnt=_miniFactory.NewToken(ObjectToContent(edge_));
      if(edgCnt==null)
      {
          edgCnt=null;
      }
...
propertiesTo[i2].SetValue(result, propertiesFrom[i].GetValue(fromObject, null), null);
  ...
  public interface IOrientRepo
  {
    ...
    T CreateEdge<T>(IorientDefaultObject edge_, IOrientVertex vFrom, IOrientVertex vTo, string dbName_ = null) where T : class, IorientDefaultObject;
