...
namespace r_build
{
    ...
    public static class InitializationParams
    {
        ...
        public enum DATE_FORMATS {EMPTY,WEEKLY,MONTHLY,DAILY,MTR,MTR_PREV,KKB}               

        public static void SetDateString(DateTime? reportDate, DATE_FORMATS reportType)
        {
            ...
            if (reportType == InitializationParams.DATE_FORMATS.WEEKLY)
            {
            ...
            if (reportType == InitializationParams.DATE_FORMATS.MONTHLY)
            {
            ...
            if (reportType == InitializationParams.DATE_FORMATS.DAILY)
            {
            ...
            if (reportType == InitializationParams.DATE_FORMATS.MTR)
            {
                InitializationParams.reportDate = InitializationParams.reportDate.Date.AddDays(1).AddMilliseconds(-1);
                dateString = InitializationParams.reportDate.ToString(@"yyyyMMdd");
            }
            if (reportType == InitializationParams.DATE_FORMATS.MTR_PREV)
            {
            ...
            if (reportType == InitializationParams.DATE_FORMATS.KKB)
            {
...
#region reg
    ...
    {      
        ...
        {
            //OPENxmlCreate();
            DateTime dt = new DateTime(2017, 08, 03, 00, 00, 00);
            ParametersInitialize(dt);
        }
        ...
        private void ParametersInitialize(DateTime? reportDate = null)
        {

            InitializationParams.SetDateString(reportDate, InitializationParams.DATE_FORMATS.MONTHLY);
            ...
            //BANKS_ULM(nameParameter);
            //BANKS_BOSCO(nameParameter);
        ...
        private void MTR(NameParameter nameParameter)
        {           
        ...
        private void WebMoney(NameParameter nameParameter)
        {
        ...
        private void ACQ_weekly(NameParameter nameParameter)
        {
        ...
        private void ACQ_monthly(NameParameter nameParameter)
        {
        ...
        private void CHANNELS(NameParameter nameParameter)
        {
        ...
        private void BANKS_ULM(NameParameter nameParameter)
        {
        ...
        private void BANKS_BOSCO(NameParameter nameParameter)
        {
            InitializationParams.dataSetCreate();
        ...
        private void QIWI(NameParameter nameParameter)
        {
            InitializationParams.dataSetCreate();
        ...
        private void INTES(NameParameter nameParameter)
        {
        ...
        private void GNS(NameParameter nameParameter)
        {
            InitializationParams.dataSetCreate();
        ...
        private void OD_DC(NameParameter nameParameter)
        {
            InitializationParams.dataSetCreate();
            InitializationParams.datasetParametrizedFill(@"OD_DC", nameParameter.hierarhyList);
            InitializationParams.StreamWriterExport(@"OD_DC", @"");
            InitializationParams.csvToXlsx(@"OD_DC", @"OD_DC_" + InitializationParams.dateString);
            InitializationParams.fileTagetSend(@"OD_DC(.*).xlsx", "OD_DC");
            InitializationParams.dataSetDispose();
        }

        private void ECOMM_FIRST(NameParameter nameParameter)
        {
            InitializationParams.dataSetCreate();
