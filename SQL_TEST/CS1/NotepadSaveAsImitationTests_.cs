...
namespace ConsoleApplication1.Tests
{
    ...
    public class NotepadSaveAsImitationTests
    {
        ...
        public void TestSetup()
        {
            ...
            notepad.Setup(s => s.SaveAs(It.IsAny<string>(), It.IsAny<byte[]>()))
        ...
        {
            notepad.Object.SaveAs(pathToGetExp,textExpected);
            notepad.Verify(s => s.SaveAs(pathToGetExp, textExpected),Times.Once);
