...
export class TestHtmlItemComponent implements OnInit {
  ...
  radio_:RadioButtonControl=new RadioButtonControl(0,"Rb","What to shoose?","Choice 2",true,new Collection_<HtmlItem>([
  ...
  date_:DatePickerControl=new DatePickerControl(0,"Dp","Choose date",new Date(2001,11,11,11,11,1),true)
  number_:NumberPickerControl=new NumberPickerControl(0,"Np","Choose number",1,-2,2,true);
