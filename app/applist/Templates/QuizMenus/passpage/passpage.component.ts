...
export class PasspageComponent implements OnInit {
  ...
  start_(q_:QuestionNew){
    ...
    ServiceCl.log(["start_",this._quiz,this._question,ModelContainerNew.quizSelected]);
  }
  swap_(){
    this._question=ModelContainerNew.questionSelected;
    ServiceCl.log(["swap_ " + this.constructor.name,ModelContainerNew.questionSelected]);
  }
