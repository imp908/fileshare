...
export class QuizItem extends NodeCollection{
  ...
  _checkCollection(n_:QuizItem){
    if((n_!=null)
    && (n_.collection!=null)
    && (n_.collection.array!=null)){
      return n_.collection;
    }else{return null;}
  }
  _Clone(){
    let r=new QuizItem({key_:this._key+1,name_:this._name,value_:this._value,collection_:null});
      this._deepClone(this,r);
    return r;
  }
  _deepClone(nc_:QuizItem,r_:QuizItem){

      if((nc_.collection!=null)
      && (nc_.collection.array!=null)
      && (nc_.collection.array.length>0)){
